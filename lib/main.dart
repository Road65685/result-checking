...
//           sectionFound = true;
//           print('Found section: "$sectionIdentifier". Extracting content for further search.');
...
//       if (!sectionFound) {
//         print('Section "$sectionIdentifier" not found on the page.');
//         return false;
//       }
...
//         print('Found "$searchText" within the "$sectionIdentifier" section.');
//         return true;
//       } else {
//         print('"$searchText" not found within the "$sectionIdentifier" section.');
//         return false;
//       }
//     } else {
//       // Handle HTTP error status codes
//       print('Failed to load page: ${response.statusCode}. Status: ${response.statusCode}');
//       return false;
//     }
//   } catch (e) {
...
//       // var g = document.getElementsByClassName('accordion-item');

//       // print(g[1].text.contains("Summer 2025"));

//       // 3. Find the div element by its ID
//       final Element? targetDiv = document.getElementById(divId);

//       if (targetDiv == null) {
//         print('Div with ID "$divId" not found on the page.');
...
//         print('No <a> tags with text containing "$linkTextToFind" found inside div "$divId".');
//       } else {
//         print('Found ${matchingLinks.length} matching <a> tags inside div "$divId".');
//       }
...
// void main() async {
//   const String targetUrl = 'https://gug.digitaluniversity.ac/results';
//   // const String searchTextToFind = 'Electrical Power System';
//   // const String sectionToFind = 'Winter 2024'; // The new parameter for the section

//   // print('Searching for "$searchTextToFind" within section "$sectionToFind" on $targetUrl...');
//   // bool found = await searchTextInWebsiteHtml(targetUrl, searchTextToFind, sectionToFind);

//   // if (found) {
//   //   print('Search successful: The text was found within the specified section.');
//   // } else {
//   //   print('Search unsuccessful: The text was not found within the specified section or an error occurred.');
//   // }

//   // print('\n--- New Function Example: Finding specific links in a div ---');

//   const String divIdToSearch = 'v-pills-all-2';
//   const String linkTextToMatch = 'M.Tech';

//   List<Element> foundLinks = await findSpecificLinksInDiv(targetUrl, divIdToSearch, linkTextToMatch);

//   String result = "No links found matching the criteria.";

//   if (foundLinks.isNotEmpty) {
//     print('Details of found links:');
//     for (var link in foundLinks) {
//       result = '  Text: ${link.text.trim()}, Href: ${link.attributes['href'] ?? 'N/A'}';
//     }
//   } else {
//     result = 'No links found matching the criteria.';
//   }

//   print(result); // Return this result;
// }
